...
BloomEffect::BloomEffect()
	...
	, mFirstPassTextures()
	, mSecondPassTextures() {
	mShaders.load(Shader::BrightnessPass, "res/Shaders/Fullpass.vert", "res/Shaders/Brightness.frag");
	mShaders.load(Shader::DownSamplePass, "res/Shaders/Fullpass.vert", "res/Shaders/DownSample.frag");
	mShaders.load(Shader::GaussianBlurPass, "res/Shaders/Fullpass.vert", "res/Shaders/GuassianBlur.frag");
	mShaders.load(Shader::AddPass, "res/Shaders/Fullpass.vert", "res/Shaders/Add.frag");
}
